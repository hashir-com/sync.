            ...
            child: OutlinedButton.icon(
              onPressed: () async {
                try {
                  ...
                  await Printing.layoutPdf(onLayout: (_) async => bytes, name: 'Invoice_${booking.id}.pdf');
                } catch (e) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Error generating invoice: $e', style: AppTextStyles.bodyMedium(isDark: true).copyWith(color: Colors.white)),
